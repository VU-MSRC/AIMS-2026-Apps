...
dll.tsf_open_recalibration_id.argtypes = [ c_char_p, c_char_p ]
dll.tsf_open_recalibration_id.restype = c_uint64
...
dll.tsf_get_calibration_id.argtypes = [ c_uint64, c_char_p, c_uint32 ]
dll.tsf_get_calibration_id.restype = c_uint32
...
class TsfData:
    ...
    def __init__ (self, analysis_directory, use_recalibrated_state=False, recalibration_id=None):
        ...
        if recalibration_id == None:
            ...
            self.handle = self.dll.tsf_open_recalibration_id(
                analysis_directory.encode('utf-8'),
